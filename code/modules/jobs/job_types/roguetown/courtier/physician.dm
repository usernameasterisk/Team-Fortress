...
/datum/outfit/job/roguetown/physician/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/storage/fancy/skit = 1, /obj/item/storage/fancy/ifak = 1, /obj/item/reagent_containers/glass/alembic = 1, /obj/item/clothing/mask/rogue/pestra/court = 1, /obj/item/thermometer = 1, /obj/item/rope/chain = 1, /obj/item/natural/cloth = 1) // tie and gag zombies
